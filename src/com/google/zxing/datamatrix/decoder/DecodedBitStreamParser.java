        ...
        throws FormatException
    {
        ...
        do
        {
            if(k >= j)
            {
                ...
                {
                    throw new RuntimeException((new StringBuilder("Platform does not support required encoding: ")).append(unsupportedencodingexception).toString());
                }
            }
...
_L3:
        if(!flag && bitsource.available() > 0) goto _L5; else goto _L1
_L4:
