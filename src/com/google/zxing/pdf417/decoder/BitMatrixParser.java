...
_L3:
        int i3 = k1 - 1;
        if(ecLevel >= 0) goto _L6; else goto _L5
_L5:
        i % 3;
...
_L9:
        ...
        i2--;
          goto _L13
_L11:
        int j2 = getCodeword(l1);
        if(ecLevel >= 0) goto _L15; else goto _L14
_L14:
        i % 3;
...
_L6:
        if((float)k1 > 6F * 1.0F) goto _L9; else goto _L8
_L8:
        int k2 = 0;
_L14:
        if(k2 < i) goto _L11; else goto _L10
_L10:
...
_L17:
        ...
        j1++;
          goto _L12
_L7:
        boolean flag1 = bitMatrix.get(l1, j1);
        BitMatrix bitmatrix = bitMatrix;
        int i2 = j1 - 1;
        if(flag1 != bitmatrix.get(l1, i2))
            k1++;
        l1++;
          goto _L13
_L11:
        if(bitMatrix.get(k2, j1))
            ai[k2] = 1 + ai[k2];
        k2++;
          goto _L14
_L9:
