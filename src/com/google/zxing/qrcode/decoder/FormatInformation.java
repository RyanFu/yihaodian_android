...
final class FormatInformation
{
    ...
    static FormatInformation decodeFormatInformation(int i, int j)
    {
        ...
        FormatInformation formatinformation1;
        if(formatinformation != null)
            formatinformation1 = formatinformation;
        else
            formatinformation1 = doDecodeFormatInformation(i ^ 0x5412, j ^ 0x5412);
        return formatinformation1;
    }
...
label0:
        {
            {
                if(i1 < FORMAT_INFO_DECODE_LOOKUP.length)
                    break label0;
                int ai[];
                int j1;
        ...
        formatinformation = new FormatInformation(ai[1]);
        if(true) goto _L2; else goto _L1
_L2:
        break MISSING_BLOCK_LABEL_32;
_L1:
        k1 = numBitsDiffering(i, j1);
        if(k1 < k)
        {
            l = ai[1];
            k = k1;
